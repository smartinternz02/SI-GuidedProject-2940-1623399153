...
def myCommandCallback(cmd):
    ...
    elif cmd.data['command']=='Light ON':
                 print("Light ON is received")


    elif cmd.data['command']=='Light OFF':
...
while True:
    ...
    data={"d":{'Waterlevel': Waterlevel,'Temperature':T,'Foodlevel':Fl}}
    def myOnPublishCallback():
        print("published Waterlevel = %s" %Waterlevel,"Temperature = %s C" %T ,"Foodlevel = %s" %Fl ,"to ibm iot platform")
